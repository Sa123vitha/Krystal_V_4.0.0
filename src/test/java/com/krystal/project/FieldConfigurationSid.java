	  ...
	  public void DataConfigconfig(ExtentTest test1, String Text1, String getdatabase, String getexcel, String Excelpath, String Sheetname) throws IOException {
		    try {
		        ...
		        for (int i = 0; i < dataEntriesFromDB.size(); i++) {
		            ...
		            {
		            	test1.pass("Database value is:"+dbColumnValue+" Data is equal "+excelValue);
		            } else {
		            	test1.fail("Database value :"+dbColumnValue+" Data is not equal to Excel value: "+excelValue);
		            }
		        }
		         ...
		         if (excelValue != null) {
		             try {
		                 ...
		                 if (dbColumnValue.equals(resultAsString)) {
		                	 test1.pass("Database value is:"+dbColumnValue+" Data is equal "+resultAsString);
		                	 
		                 } else {
		                	 test1.fail("Database value is:"+dbColumnValue+" Data is equal "+resultAsString);
		                 }
